...
ggplot(summary_df, aes(x=canc_type, y=sl_pairs, size = -log(as.numeric(as.character(mut_pvalue)), base = 10))) + 
      ...
      theme(panel.grid.major = element_line(size = 0.1),
            ...
            axis.ticks.y = element_blank(),
            axis.text.y=element_text(angle=0, size=11,colour="#525252"),
            axis.text.x = element_text(angle = 30, size=11, vjust=1, hjust=1, colour="#525252"),
            axis.title.x=element_text(angle=0, size=14,colour="#525252"),
            axis.title.y=element_text(angle=90, size=14,colour="#525252"),
            legend.position="bottom",
            legend.title = element_text(angle=0, size=12,colour="#525252"),
            panel.border = element_blank()) +
    scale_x_discrete(labels = c("Autonomic ganglia", "Bone", "Breast", "CNS", "Endometrium", "Blood", "Kidney", "Large intestine", "Liver", "Lung",
                                "Oesophagus", "Ovary", "Pancreas", "Pleura", "Skin", "Soft tissue", "Stomach", "UADT", "Urinary tract") )
```
